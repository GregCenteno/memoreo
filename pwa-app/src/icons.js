...
const PATHS = {
  ...
  eyeOff: '<path d="M3 3l18 18"/><path d="M10.6 5.2A10.6 10.6 0 0 1 12 5c6.4 0 10 7 10 7a15.6 15.6 0 0 1-3.4 4.4M6.6 6.6C4 8.3 2 12 2 12s3.6 7 10 7c1.4 0 2.7-.3 3.9-.8"/><path d="M9.9 9.9a3 3 0 0 0 4.2 4.2"/>',
  moon: '<path d="M20 14.5A8.5 8.5 0 1 1 9.5 4a7 7 0 0 0 10.5 10.5z"/>',
  rx: '<path d="M6 3h8l4 4v14H6z"/><path d="M14 3v4h4"/><path d="M10 12.5v4M8 14.5h4"/><path d="M9 19h6"/>',
  ...
  whatsapp: '<path d="M12 3a9 9 0 0 0-7.8 13.5L3 21l4.6-1.2A9 9 0 1 0 12 3z"/><path d="M8.7 8.4c.3-.6.6-.7 1-.7h.4c.3 0 .5.1.7.6l.5 1.2c.1.3.1.5-.1.8l-.4.5c-.1.2-.1.3 0 .5.3.6 1.6 2.1 3.1 2.7.2.1.4 0 .5-.1l.5-.6c.2-.2.4-.3.7-.1l1.2.6c.3.2.5.3.6.6 0 .3 0 .8-.2 1.1-.3.5-1.1.9-1.6 1-.5.1-1 .1-2.5-.5-1.9-.8-3.4-2.3-4.3-3.9-.3-.6-.3-1.2-.1-1.7z"/>'
};
